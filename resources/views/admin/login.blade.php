...
<html lang="en">
<head>
	<title>Login|Roy's Invest|Admin Panel</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" type="image/png" href="{{asset('assets/img/logo background.webp')}}"/>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
                    ...
                    <img src="{{ asset('assets/img/logo2.webp') }}" alt="IMG">
				</div>
